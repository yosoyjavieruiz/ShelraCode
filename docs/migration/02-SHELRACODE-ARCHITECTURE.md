...
This is the appropriate application-level entry point for the Grok shell: it can supply a route and execution profile without exposing provider SDK objects to React components.
