...
| Top bar                | `ShelraCode`, `workspace / main`, route and privacy are rendered as one bordered row. Model and mode are absent.                                                                              | Quiet location bar: brand, repository/branch, mode, route/model and privacy, with responsive omission rules.                                                                                   |
