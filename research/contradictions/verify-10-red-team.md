...
| D5 | Sources E6: a per-author commit figure | this repository | Internally impossible: the per-author figure exceeds the confirmed total of 173 commits. | **DISPUTED** | Drop the per-author figure. Not used in the lane body, so no downstream effect. |
...
| D7 | Sources E2: an npm package's "33 versions" | registry.npmjs.org | Registry returns latest 0.0.34 and modified 2025-11-27 (both correct) with **34** versions. | **DISPUTED** | Off by one; correct to 34. |
...
- **Star counts** — spec-kit 134,096 / claude-code 144,441 / llama.cpp 127,506 re-read hours later as
  134,105 / 144,442 / 127,507. Ordinary drift; treat as verified. OpenSpec 67,659 and aider 48,832
  (pushed 2026-05-22) matched to the digit.
